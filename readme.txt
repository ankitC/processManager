...
5. On the master server, execute:
   ...
   You should see the numbers 1 through 13 start to print 
   on the screen of worker 0, one number every second.
...
7. Now, resume the process on the other worker:
   ...
   You should see the last few numbers print to worker 1's screen.	
